...
var (
	...
	ErrorUserAlreadyExist        = "user.User already exists"
...
func FetchUsers(tableName string, name string, dynaClient dynamodbiface.DynamoDBAPI) (*[]User, error) {
